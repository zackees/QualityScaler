...
* `2026.3.0` - Updated to upstream main's 2026.3 app cleanup with UTF-8 stream handling and provider-detection logging.
* `2026.2.0` - Updated to upstream 2026.2 with DirectML engine 1.24.4, expanded model choices, and refactored video encoding workflow.
...
* `4.5.0` - Updated to upstream 4.5 with FFmpeg-based frame extraction, faster frame saving, and frame-directory workflow improvements.
