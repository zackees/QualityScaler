...
from qualityscaler.core.models import ModelManifestEntry, _package_dir, parse_manifest_entry
...
def default_model_path(model_name: str) -> str:
    return os.path.join(_package_dir(), "AI-onnx", f"{model_name}_fp32.onnx")
